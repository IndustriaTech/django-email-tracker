...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrackedEmailEvent.recipient'
        db.add_column('email_tracker_trackedemailevent', 'recipient',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=254),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrackedEmailEvent.recipient'
        db.delete_column('email_tracker_trackedemailevent', 'recipient')
    ...
    models = {
        ...
        'email_tracker.trackedemailevent': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipient': ('django.db.models.fields.EmailField', [], {'default': "''", 'max_length': '254'})
        }
    }
