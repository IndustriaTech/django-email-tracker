...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TrackedEmailAlternative'
        db.create_table('email_tracker_trackedemailalternative', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.related.ForeignKey')(related_name='alternatives', to=orm['email_tracker.TrackedEmail'])),
            ('mimetype', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('email_tracker', ['TrackedEmailAlternative'])


    def backwards(self, orm):
        # Deleting model 'TrackedEmailAlternative'
        db.delete_table('email_tracker_trackedemailalternative')
